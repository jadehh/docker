...
docker build --build-arg CUDA_ARCH_BIN="8.6"  --build-arg Operation_VERSION="ubuntu18.04"  --build-arg CUDA_VERSION="11.6.2"  -t  jadehh/onnx:11.6.2-arch-8.6-devel-ubuntu20.04  .
```
## runtime
```bash
cd 开发环境
